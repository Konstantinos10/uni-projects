...
if username:
    try:
        ...
        with st.expander("Challenge Yourself Through Our Quizzes", icon="✍️"):
        ...
        with st.expander("Code Freely In Our Playground Editor", icon="👨‍💻"):
        ...
        with st.expander("Get Instant Help From Our ChatBot", icon="🤖"):
